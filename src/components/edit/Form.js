...
import { useEditVideoMutation } from "../../fatures/api/apiSlice";
import TextArea from "../ui/TextArea";
import TextInput from "../ui/TextInput";

export default function Form({video}) {
    const [editVideo] = useEditVideoMutation()
    const {id, title: initialTitle, description: initialDescription, author: initialAuthor, link: initialLink, thumbnail: initialThumbnail, date: initialDate, duration: initialDuration, views: initialViews} = video || {}
    console.log(video);
